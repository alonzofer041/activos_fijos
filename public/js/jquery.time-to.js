    ...
    $.fn.timeTo = function () {
        ...
        return this.each(function () {
            ...
            if (!data.vals) {
                ...
                //     ? (data.displayHours
                //             ? '<div style="max-width:' + maxWidth + 'px">$1<b' + fsStyle + '>'
                //                 + language.hours + '</b></div>' + dot2
                //             : '')
                //         + '<div style="max-width:' + maxWidth + 'px">$1<b' + fsStyle + '>' + language.min
                //         + '</b></div>' + dot2
                //         + '<div style="max-width:' + maxWidth + 'px">$1<b' + fsStyle + '>' + language.sec
                //         + '</b></div>'
                ...
                thtml = (data.displayCaptions
                    ? (data.displayHours
                            ? '<div style="max-width:' + maxWidth + 'px">$1</div><b' + fsStyle + '>'
                                + language.hours + '</b>' + dot2
                            : '')
                        + '<div style="max-width:' + maxWidth + 'px">$1</div><b' + fsStyle + '>' + language.min
                        + '</b>' + dot2
                        + '<div style="max-width:' + maxWidth + 'px">$1</div><b' + fsStyle + '>' + language.sec
                        + '</b>'
                    : (data.displayHours ? '$1' + dot2 : '') + '$1' + dot2 + '$1'
                ).replace(/\$1/g, dhtml1 + dhtml2);
